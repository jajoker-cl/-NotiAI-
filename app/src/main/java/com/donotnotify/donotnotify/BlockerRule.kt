...
data class BlockerRule(
    ...
    /**
     * Rule origin: "manual", "import", "ai_auto", "prebuilt", etc.
     * Null for legacy rules created before this field was introduced.
     */
    val source: String? = null,
    /**
     * AI-specific metadata attached when the rule was auto-generated by [AiRuleGenerator].
     * Null for manually created rules.
     */
